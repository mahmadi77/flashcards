...
public partial class copylesson : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        bool ownLesson = dao.ValidateUserOwnsLesson(userId, lessonId);
        bool queryStringSaysToIgnore = Request.QueryString["ownlesson"] != null;

        if (!ownLesson || queryStringSaysToIgnore)
        {
            // Copy the lesson
