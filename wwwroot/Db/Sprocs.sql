...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertUser' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetUser' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetUsageStatusDescriptions' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetUsageStatusDescriptions
go

create procedure dbo.GetUsageStatusDescriptions(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetDemoLessons' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetDemoLessons
go

create procedure dbo.GetDemoLessons
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLesson
go

create procedure dbo.GetLesson(@LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertLessonEntry' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertLessonEntry
go

create procedure dbo.InsertLessonEntry(
	@LessonId int,
	@Entry nvarchar(500),
	@Translation nvarchar(500),
	@Accents nvarchar(500) = null,
	@AccentsBack nvarchar(500) = null)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetMyLessons' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetMyLessons
go

create procedure dbo.GetMyLessons(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertLesson' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertUserLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertUserLesson
go
create procedure dbo.InsertUserLesson(@LessonId int, @UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ExistsUser' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ExistsUser
go

create procedure dbo.ExistsUser(@Username nvarchar(20), @Email nvarchar(50))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ValidateUserOwnsLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ValidateUserOwnsLesson
go

create procedure dbo.ValidateUserOwnsLesson(@UserId int, @LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'CopyLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.CopyLesson
go

create procedure dbo.CopyLesson(@UserId int, @LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ValidateUserInfo' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ValidateUserInfo
go

create procedure dbo.ValidateUserInfo(@user nvarchar(50), @password nvarchar(10))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonSettings
go

create procedure dbo.GetLessonSettings(@LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateLessonSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdateLessonSettings
go

create procedure dbo.UpdateLessonSettings(
	@LessonId int,
	@LessonName nvarchar(100),
	@Speed int,
	@Direction bit,
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonEntries' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonEntries
go

create procedure dbo.GetLessonEntries(@LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.DeleteLesson
go

create procedure dbo.DeleteLesson(@LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteUserLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.DeleteUserLesson
go

create procedure dbo.DeleteUserLesson(@LessonId int, @UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteUser' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonEntry' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonEntry
go

create procedure dbo.GetLessonEntry(@LessonEntryId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateLessonEntry' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdateLessonEntry
go

create procedure dbo.UpdateLessonEntry(@LessonEntryId int, @Entry nvarchar(500), @Translation nvarchar(500), @Accents nvarchar(500) = null, @AccentsBack nvarchar(500) = null)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteLessonEntry' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.DeleteLessonEntry
go

create procedure dbo.DeleteLessonEntry(@LessonEntryId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetConfigurationSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetConfigurationSettings
go

create procedure dbo.GetConfigurationSettings
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateVerified' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdateVerified
go

create procedure dbo.UpdateVerified(@VerificationGuid varchar(100))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ValidateUserInfoFromGuid' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ValidateUserInfoFromGuid
go

create procedure dbo.ValidateUserInfoFromGuid(@VerificationGuid varchar(100))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateVerificationGuid' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdateVerificationGuid
go

create procedure dbo.UpdateVerificationGuid(@verificationguid varchar(100), @email nvarchar(50))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ResetPassword' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ResetPassword
go

create procedure dbo.ResetPassword(@verificationguid varchar(100), @password nvarchar(10))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateEntryOrder' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdateEntryOrder
go

create procedure dbo.UpdateEntryOrder(@LessonEntryId int, @SortOrder int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdatePassword' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdatePassword
go

create procedure dbo.UpdatePassword(@userId int, @password varchar(10))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ValidatePassword' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ValidatePassword
go

create procedure dbo.ValidatePassword(@userId int, @password varchar(10))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetUserSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetUserSettings
go

create procedure dbo.GetUserSettings(@userId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertUserSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertUserSettings
go
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateUserSettings' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetThemes' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetSharedLessons' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetSharedLessons
go

create procedure dbo.GetSharedLessons(@ResultsPerPage int, @PageNumber int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'fn_ParseCommaDelimitedStringToTable' and ROUTINE_SCHEMA = 'dbo')
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'SearchLessons' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.SearchLessons
go

create procedure dbo.SearchLessons(@SearchTerms nvarchar(1000))
as
...
create procedure dbo.IncrementNumViews(@LessonId int, @UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ToggleSolo' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ToggleSolo
go

create procedure dbo.ToggleSolo(@EntryId int, @Soloed bit)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertLessonGroup' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertLessonGroup
go

create procedure dbo.InsertLessonGroup(@Name nvarchar(200), @UserId int, @LessonGroupId int out)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertLessonGroupLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertLessonGroupLesson
go

create procedure dbo.InsertLessonGroupLesson(@LessonGroupId int, @LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteLessonGroupLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.DeleteLessonGroupLesson
go

create procedure dbo.DeleteLessonGroupLesson(@LessonGroupId int, @LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteLessonGroup' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.DeleteLessonGroup
go

create procedure dbo.DeleteLessonGroup(@LessonGroupId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonGroups' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonGroups
go

create procedure dbo.GetLessonGroups(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ValidateUserOwnsLessonGroup' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ValidateUserOwnsLessonGroup
go

create procedure dbo.ValidateUserOwnsLessonGroup(@UserId int, @LessonGroupId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonGroup' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonGroup
go

create procedure dbo.GetLessonGroup(@LessonGroupId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonGroupAsLesson' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonGroupAsLesson
go

create procedure dbo.GetLessonGroupAsLesson(@LessonGroupId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetLessonGroupSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetLessonGroupSettings
go

create procedure dbo.GetLessonGroupSettings(@LessonGroupId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'UpdateLessonGroupSettings' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.UpdateLessonGroupSettings
go

create procedure dbo.UpdateLessonGroupSettings(
	@LessonGroupId int,
	@Name nvarchar(200),
	@Speed int,
	@Direction bit,
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertSubscriptionHistory' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertSubscriptionHistory
go

create procedure dbo.InsertSubscriptionHistory(@UserId int, @Date datetime, @UsageStatusCode varchar(2))
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetUsageStatus' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetUsageStatus
go

create procedure dbo.GetUsageStatus(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ExpireUsage' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ExpireUsage
go

create procedure dbo.ExpireUsage(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetNumEntries' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetNumEntries
go

create procedure dbo.GetNumEntries(@LessonId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'ReachedMaxPrivateLessons' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.ReachedMaxPrivateLessons
go

create procedure dbo.ReachedMaxPrivateLessons(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'GetUserStatistics' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.GetUserStatistics
go

create procedure dbo.GetUserStatistics(@UserId int)
as
...
if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DeleteUnregisteredUsersLessons' and ROUTINE_SCHEMA = 'dbo')
...
---------------------------------------------------------------------------
-- SPROC: InsertLessonAccess
---------------------------------------------------------------------------

if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'InsertLessonAccess' and ROUTINE_SCHEMA = 'dbo')
	drop procedure dbo.InsertLessonAccess
go

create procedure dbo.InsertLessonAccess(@LessonId int, @UserId int)
as

insert into lessonaccesses (lessonid, userid) values (@lessonid, @userid)
